...
|  Pre-Flood                                                                                             |  Pre-Flood                                                                                          |
|------------------------------------|------------------------------------|
| ![](Images/[map2] accessibility/Healthcare Facility Accessibility on foot [no flood].jpg){width="335"} | ![](Images/[map2] accessibility/Healthcare Facility Accessibility on foot [flood].jpg){width="323"} |
...
|  Pre-Flood                                                                                  |  Post-Flood                                                                              |
|------------------------------------|------------------------------------|
| ![](Images/[map2] accessibility/Education Facility Accessibility on vehicle [no flood].jpg) | ![](Images/[map2] accessibility/Education Facility Accessibility on vehicle [flood].jpg) |
...
| Pre-Flood                                                                                | Post-Flood                                                                            |
|------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|
| ![](Images/[map2] accessibility/Education Facility Accessibility on foot [no flood].jpg) | ![](Images/[map2] accessibility/Education Facility Accessibility on foot [flood].jpg) |
...
![](Images/[map3] service area/healthcare vehicle.png){fig-align="center" width="435"}
...
![](Images/[map3] service area/healthcare foot.png){fig-align="center" width="435"}
...
![](Images/[map3] service area/evacuation vehicle.png){fig-align="center" width="435"}
...
![](Images/[map3] service area/evacuation foot.png){fig-align="center" width="435"}
